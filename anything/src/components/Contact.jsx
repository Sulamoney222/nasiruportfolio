...
const Contact = () => {
  return (
    ...
    <div className="container mt-10 lg:grid lg:grid-cols-2 lg:itms-strecth ">
       ...
       Contact Me For Collaboration
        ...
        <p className='text-zinc-600 mt-3 mb-8 max-w-[5] lg:max-w-[30ch]'>
            Reach out today to discuss your project needs and start collaborating on someting amazing
        </p>
        ...
        <form action="https://getform.io/f/apjnnkqa" 
        className=" xl:pl-10 2xl:pl-20 "
         ...
         <button 
         type='submit' 
         className="btn btn-primary [&]:max-w-full w-full h-full justify-center">Submit</button> 
         </div>
        </form>
