...
const works = [
...

  {
    ...
    desc:'This shop website enables users to efficiently secure customer orders, boost sales, and manage transactions, providing a smooth and reliable online shopping platform.',
  ...
  },
  {
    ...
    desc:`This is a movie website that features the latest releases and trending films, keeping viewers up to date with what's new and popular.`,
    projectLink: 'https://new-movie-website.vercel.app/'
  },
  {
    imgSrc: quiz,
    ...
    desc:'This quiz website offers a comprehensive collection of over 500 medical questions, making it an ideal tool for students, professionals, and anyone looking to assess and improve their understanding of medical concepts and practices.',
  ...
  {// https://sulamoney-mc-qs-ashen.vercel.app/
    ...
    {label:'CSS'},
    ,{label:'Api'}],
    desc:'This website is designed for cocktail lovers, providing an extensive collection of drink recipes, bartending tips, and mixology guides to inspire both beginners and seasoned professionals',
  ...
  },
  {
      ...
      desc:'This mobile application delivers up-to-date educational content, helping users stay informed about the latest trends, news, and developments across multiple areas of knowledge.',
